  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-stone-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-stone-950 dark:focus-visible:ring-stone-300",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-yellow-500 bg-white hover:bg-stone-100 hover:text-stone-900 dark:border-yellow-600 dark:bg-stone-950 dark:hover:bg-stone-800 dark:hover:text-stone-50",
        outline2:
          "border-2 border-white bg-white hover:bg-stone-100 hover:text-stone-900 dark:border-yellow-600 dark:bg-stone-950 dark:hover:bg-stone-800 dark:hover:text-stone-50",
        secondary:
